...
function ProductRegistration() {
  ...
  const registerProduct = async () => {
    try {
      // Replace the following Axios put request with your actual backend endpoint and payload
      await Axios.put(`http://54.236.200.66/Productos/${productName}`, {
        ID_Producto: productName,
        Precio: productType,
        Nombre_producto: productWeight,
        ID: productPrice,
      });
      ...
      <div className='form-panel'>
        <form onSubmit={handleFormSubmit}>
          <div className='form-group'>
            <label htmlFor='productName'>ID del Producto:</label>
            <input
              type='text'
              id='productName'
              value={productName}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productType'>Precio del producto:</label>
            <input
              type='text'
              id='productType'
              value={productType}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productWeight'>Nombre del producto:</label>
            <input
              type='text'
              id='productWeight'
              value={productWeight}
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productPrice'>ID:</label>
            <input
              type='text'
              id='productPrice'
              value={productPrice}
