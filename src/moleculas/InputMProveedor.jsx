...
function ProductRegistration() {
  ...
  const registerProduct = () => {
    ...
    Axios.put(`http://54.236.200.66/Inventario/${productName}`, {
    ...
    <div className='container-product'>
      ...
      <div className='form-panel'>
        <form onSubmit={handleFormSubmit}>
          ...
          <br />
          <div className='form-group'>
            <label htmlFor='productType'>Cantidad del producto:</label>
            <input
              type='text'
              id='productType'
              value={productType}
          ...
          <div className='form-group'>
            <label htmlFor='productWeight'>Ubicacion:</label>
            <input
              type='text'
              id='productWeight'
              value={productWeight}
      ...
      <div className='buscador-panel' style={{ position: 'absolute', top: '10px', right: '10px' }}>
        <Buscador seccion={'Pedidos'} />
      </div>
    </div>
  );
}
